...
if (vjs.CDN_VERSION !== 'GENERATED'+'_CDN_VSN') {
  videojs.options['flash']['swf'] = 'http://123.30.242.150:3000/assets/SohaPlayer.swf';
}
...
vjs.Component.prototype.addChild = function(child, options){
  ...
  if (typeof child === 'string') {
    ...
    component = new window['sohatv'][componentClass](this.player_ || this, options);
...
vjs.Player.prototype.loadTech = function(techName, source){
  ...
  this.tech = new window['sohatv'][techName](this, techOptions);
...
vjs.Player.prototype.src = function(source){
  ...
  // case: Source object { src: '', type: '' ... }
    ...
    if (source.type && !window['sohatv'][this.techName]['canPlaySource'](source)) {
      ...
      this.ready(function(){
        ...
        if (window['sohatv'][this.techName].prototype.hasOwnProperty('setSource')) {
