...
var videojs = window['videojs']  = window['vcplayer'] = window['sohatv'] = vjs; // TuanLDT
...
// The added (+) blocks the replace from changing this 1.0 string
if (vjs.CDN_VERSION !== 'GENERATED'+'_CDN_VSN') {
  videojs.options['flash']['swf'] = videojs.ACCESS_PROTOCOL + 'vjs.zencdn.net/'+videojs.CDN_VERSION+'/video-js.swf';
}
...
function _logType(type, args){
  ...
  // TuanLDT edit --S
  argsArray.unshift('VCPlayer:'); //VIDEOJS -> VCPlayer
  // TuanLDT edit --E
...
vjs.SliderHandle.prototype.createEl = function(type, props) {
  ...
  if(props.className.toString() == 'vjs-seek-handle'){
    props.className = props.className + ' vjs-slider-handle';
  }
  if(props.className.toString() == 'vjs-volume-handle'){
    props.className = props.className + ' vjs-volume-handler';
  }
  props = vjs.obj.merge({
...
vjs.ErrorDisplay = vjs.Component.extend({
  init: function(player, options){
    ...
    this.update();
    //this.on(player, 'error', this.update); // TuanLDT
  }
});

vjs.ErrorDisplay.prototype.createEl = function(){
  var el = vjs.Component.prototype.createEl.call(this, 'div', {
    className: 'vcplayer-error-display' // TuanLDT
  });
