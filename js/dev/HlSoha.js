(function(window, videojs, document, undefined){
	...
	videojs.Hls.prototype.fillSegments = function(offset) {
	...
	videojs.Hls.prototype.loadSegment1 = function(segmentUri, offset, segIndex) {
	  var i = 0,
	    tech = this,
	    player = this.player(),
	    settings = player.options().hls || {};
	  ...
	  this.segmentXhrs_[segIndex] =  segmentXhr_ = videojs.Hls.xhr({
	    ...
	    if (error) {
	      ...
	      tech.trigger('segLoadError', tech.error);
	...
	videojs.Hls.prototype.typeToString = function() {
	  switch(this.type) {
	    case 0: {
	      return "LIVE";
	    }
	...
	videojs.Hls.prototype.changeLevelPlaylist = function() {
	  var 
	    tech = this,
	    sortedPlaylists = this.playlists.master.playlists.slice();
	...
	videojs.Hls.prototype.segLoadErrorHandler = function(error) {
	...
	videojs.Hls.prototype.manifestErrorHandler = function() {
	  //console.log(this.playlists.error);
	}

	videojs.Hls.prototype.p2pInit = function() {
	  var tech = this;
	...
	videojs.Hls.prototype.p2pReset = function() {
	  var tech = this;
	  tech.firstSegment = false;
	  tech.segmentLoadError = {};
	  tech.isRetrySegment = false;
